-- some functions print something after they get run, silet=ture, prevents that.
...
-- when you copy something, then past it in place of something else, that something else gets copied, this prevents that.
keymap("v", "p", '"_dP', opts)
